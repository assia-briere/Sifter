...
<div id="langage">
<form class="row g-3 langage-form" id="langage-form">
  <div class="personel">
    <div class="row">
      <div class="col-md">
...
<div id="loisir">
<form class="row g-3 loisir-form" id="loisir-form">
  <div class="personel">
    <div class="row">
      <div class="col-md">
...
<input id="submit-all-forms-button" type="submit" style="display:none;" class="btn n none" name="sumbit" >
    </form>
    </div>
</div>
