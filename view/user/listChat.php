    ...
    <div class="sidebar">
        ...
        <nav>
            ...
            <ul>
                ...
                <li class="nav-item">
                    <a href="../recruteur/userprofile.php">
                        <i class='bx bxs-user-detail'></i>
                        <span>Profile</span>
                    </a>
                </li>
                <li class="nav-item active ">
                    <a href="./listChat.phpl">
    ...
    ?>
        <div class="card">
            <div class="user">
                ...
                <h5><a class="hon" href="./chat.php?id=<?php echo $idc?>"><?php echo  $nom." ".$prenom ?></h5></a>
            ...
            <button class="btn btn_outline" id ="<?php echo 'msg'.$idc?>">Message</button>
            <script>
var message = document.getElementById('<?php echo 'msg'.$idc?>');
   message.addEventListener('click' , () =>{
    window.location.href = "./chat.php?id=<?php echo $idc?>";
