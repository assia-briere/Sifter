...
include_once dirname(__DIR__) . "../../controller/CandidatureController.php";
    $Cand = new ControllerCant();
    $Cont = new offerController();
    $candidats = $Cont->getOffer();;
        ...
        <nav>
            ...
            <ul>
                <li class="nav-item active">
                    <a href="../recruteur/dashboard.php">
                        <i class="bx bxs-dashboard"></i>
                        <span>Dashboard</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="./userprofileCan.php">
    ...
    ?>
        <div class="card">
            <div class="user">
                ...
                <h5><a class="hon" href="../user/userprofile.php?id=<?php echo $idc?>"><?php echo  $nom ?></h5></a>
                <input type="hidden" value="<?php echo $idc?>">
                <small>Entreprise : <?php echo $prenom?></small><br>
                <small>localisation : <?php echo $localisation?></small><br>
                </div>
            </div>
            ...
            <button id="<?php echo 'id'.$idc?>">Postuler</button>
            <script>
                var post =document.getElementById('<?php echo 'id'.$idc?>');
                post.addEventListener('click', () => {
                    <?php  $Cand->setCandidatures($_SESSION['id'],$row['id']);?>;
